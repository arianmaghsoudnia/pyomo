...
MaxC = {'TES':0,'BAT':0} #case 1 : No electric and thermal storages available
MaxC = {'TES':2000,'BAT':0} #case 2 : Thermal storage with capacity equal to 2 MWh, no battery
MaxC = {'TES':2000,'BAT':1000} #case 3 : Thermal storage with capacity equal to 2 MWh, and battery with capacity equal to 1 MWh
MaxC = {'TES':4000,'BAT':1000} #case 4 : Thermal storage with capacity equal to 4 MWh, and battery with capacity equal to 1 MWh
